    ...
    <section className="bg-white py-12 sm:py-16 md:py-20">
      <div className="grid w-full items-center gap-8 px-4 sm:gap-10 sm:px-6 md:px-8 lg:grid-cols-2 lg:gap-16 lg:px-10 xl:px-12">
        <div>
          ...
          <SmoothParagraph className="mt-4 max-w-xl text-lg leading-relaxed text-slate-600">
          ...
          <div className="mt-8 grid max-w-md grid-cols-3 gap-4">
            {stats.map((item) => (
              <div key={item.label} className="text-left">
                <SmoothParagraph className="text-4xl font-normal text-slate-700">{item.value}</SmoothParagraph>
                <SmoothParagraph className="mt-1 text-xs font-light uppercase tracking-wide text-slate-500">
                  {item.label}
                </SmoothParagraph>
              </div>
            ))}
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-5 -left-5 z-10 flex items-center gap-3 rounded-xl border border-jaz-dark/30 bg-white px-5 py-3.5 shadow-lg sm:-bottom-6 sm:-left-8 lg:-left-10">
            ...
            <div>
              <SmoothParagraph className="text-sm font-semibold text-jaz-dark">Expert Team</SmoothParagraph>
              <SmoothParagraph className="text-xs text-slate-500">Professional Service</SmoothParagraph>
            </div>
          </div>
        </div>
      </div>
